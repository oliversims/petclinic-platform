...
#
# Linked: helm-values/dev.yaml placeholders; k8s/argocd/ingress/dev.yaml.
# =============================================================================
...
output "github_actions_role_arn" {
  description = "IAM role ARN for GitHub Actions. Set as AWS_ROLE_ARN on the app fork."
...
# -----------------------------------------------------------------------------
# 5) Karpenter (NodePool / EC2NodeClass YAML)
# -----------------------------------------------------------------------------
